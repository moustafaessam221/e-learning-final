          ...
          <Card className="mb-4 h-100 cards-height">
            <Card.Body>
              <div className="mb-4">
                ...
                <li>
                    <FontAwesomeIcon icon={faCheck}/> Access to introductory lessons
                  </li>
                <li>
                <FontAwesomeIcon icon={faTimes}/> Certificate
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faCheck}/>  Limited course topics
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faCheck}/> Community support
                  </li>
                </ul>
            ...
            <Card.Body>
              <div className="mb-4">
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <FontAwesomeIcon icon={faCheck}/> Certificate
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faCheck}/>  Regularly updated content
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faCheck}/> Premium support
                  </li>
                </ul>
            ...
            <Card.Body>
              <div>
                ...
                <ul className="list-unstyled">
                  ...
                  <li>
                    <FontAwesomeIcon icon={faCheck}/>  Save more with yearly billing
                  </li>
                  <li>
                    <FontAwesomeIcon icon={faCheck}/> Priority support and exclusive resources
                  </li>
                </ul>
